...
public class IssueListServiceImpl implements IssueListService {
    ...
    public void sendIssue(CreateIssueRequest createIssueRequest) {
        URI uri = URI.create(ApiConfig.getApiBackendUrl() + "/issue/create");
    ...
    @Override
    public List<IssueBubbleDto> getLatestSelfIssues(String userId) {
        URI uri = URI.create(ApiConfig.getApiBackendUrl() + "/issue/line-user/get/" + userId + "/latest");
    ...
    public List<IssueBubbleDto> getIssuesByDistinctUser(String userId) {
        URI uri = URI.create(ApiConfig.getApiBackendUrl() + "/issue/line-user/get/" + userId + "/distinct");
        List<IssueBubbleDto> issueBubbleDtoList = webClientConfig.webClient()
                .get()
                .uri(uri)
                .retrieve()
    ...
    public List<IssueBubbleDto> getSubscribedIssues(String userId) {
        URI uri = URI.create(ApiConfig.getApiBackendUrl() + "/issue/line-user/get/" + userId + "/subscribed");
        List<IssueBubbleDto> issueBubbleDtoList = webClientConfig.webClient()
                .get()
                .uri(uri)
                .retrieve()
